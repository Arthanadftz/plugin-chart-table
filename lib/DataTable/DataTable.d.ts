...
export default function DataTable<D extends object>({ tableClassName, columns, data, width: initialWidth, height: initialHeight, pageSize: initialPageSize, initialState: initialState_, pageSizeOptions, maxPageItemCount, sticky: doSticky, searchInput, selectPageSize, noResults, hooks, wrapperRef: userWrapperRef, ...moreUseTableOptions }: DataTableProps<D>): JSX.Element;
